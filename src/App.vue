  ...
  <div class="main-container">
    ...
    <section class="about-me section-row glass" id="about-me">
      ...
      <div class="my-introduction showup">
        <p>{{ $t("home.info") }}</p>
        <p>
          passion for creatiniaho你好W <br />我是叶寒一名后端工程师ng hello, I
          am YeHan, a software developer with bra passion for creating
        </p>
        <p>
          innovative solutions. Welcome to my portfolio! innovative solutions.
